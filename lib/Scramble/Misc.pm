...
my @g_links = ({ 'URL' => '../../g/m/home.html',
		...
		'no-display' => 1,
		 ...
		 'name' => 'Favorite photos',
	       ...
	       { URL => qq(../../g/m/maps.html),
		 'name' => 'Maps',
		 'no-display' => 1,
	     },
	       { URL => qq(../../g/m/pictures-with-paths.html),
		 'name' => 'Pictures w/names',
		 'no-display' => 1,
	     },
	       { URL => qq(../../g/m/picturessorted-by-date.html),
		 'name' => 'Pictures sorted by date',
		 'no-display' => 1,
	     },
...
sub make_3_column_page {
	...
	$in_table_footer_html = qq(<tr valign="top" align="left"><td colspan="3">$footer_html</td></tr>);
    }
    my $two_cell_row = (exists $options{'two-cell-row'} 
			? qq(<tr valign="top" align="left"><td valign="top" align="left"></td><td colspan="2">$options{'two-cell-row'}</td></tr>)
			: '');
...
#     }
    ...
    my $links = '';
    if (! $options{'no-links-box'}) {
        $links = get_links_html("only-get-displayable-links");
    }
...
<head>
    ...
    <link rel="SHORTCUT ICON" href="../../pics/favicon.ico">
    <meta name="description" content="Scramble trip reports and pictures from scrambles in the Washington state's Snoqalmie Pass and Middle Fork Snoqualamie area">
</head>
<body bgcolor="white">
<h1>$h1_title</h1>
<table width="100%" border=0 cellpadding="5">
